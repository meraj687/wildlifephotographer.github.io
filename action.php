...
if(isset($_POST["action"]))
{
 ...
 if($_POST["action"] == "fetch")
 {
  ...
  $output = '
   <table class="table table-bordered table-striped table-color=red">  
    <tr>
     <th width="10%">ID</th>
  ...
  while($row = mysqli_fetch_array($result))
  {
   $output .= '
    ...
    <tr>
     <td>'.$row["id"].'</td>
     <td>
      <img src="data:image/jpeg;base64,'.base64_encode($row['name'] ).'" height="182.88" width="182.88" class="img-thumbnail" />
     </td>
